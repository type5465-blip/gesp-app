...
{id: '2025-06',
        ...
        questions: [
            ...
            { type:'single', q:'阅读下⾯的 Python 代码，横线上应填⼊的代码是（ ）。', options:["{2025-int(YearOld)}", "{2025-YearOld}", "{2025}-{int(YearOld)}", "{2025}-{YearOld}"], answer:0, explain:'本题正确答案为正选项。详细解析请参考CCF GESP官方真题答案解析文档。' },
            { type:'single', q:'下⾯ Python 代码执⾏后的输出是（ ）。', options:["a+b= 7 a+b={a+b}", "a+b=7 a+b=7", "a+b=7a+b={a+b}", "a+b=7a+b=7x = 10 y = 20 x = x + y y = x - y x = x - y print(x, y)1 2 3 4 5 6 a, b, c = 3, 4, 5 print(f\"a={a} b={b} c={c},a^2+b^2={a**2+b**2},c^2={c**2}\")1 2 YearOld = input(\"您今年的整数年龄是 ?\") print(f\"您出生于"], answer:0, explain:'本题正确答案为正选项。详细解析请参考CCF GESP官方真题答案解析文档。' },
            { type:'single', q:'下⾯的 Python 代码⽤于求 M 天后是星期⼏，横线处应填⼊的代码是（ ）。', options:["(N+M)//7 且 D==0", "(N+M)%7 且 D==0", "(N+M)//7 且 D<=0", "(N+M)%7 且 D=0"], answer:1, explain:'本题正确答案为A选项。详细解析请参考CCF GESP官方真题答案解析文档。' },
            { type:'single', q:'下⾯ Python 代码执⾏后输出是（ ）。', options:["END", "1#", "1#4#END", "1#4#7#10#END"], answer:0, explain:'本题正确答案为正选项。详细解析请参考CCF GESP官方真题答案解析文档。' },
            { type:'single', q:'下⾯的 Python 代码⽤于求 N 的所有因数，如输⼊ 12 则将输出12,6,4,3,2,1,。（ ）。N = int(input("当前星期几？ ")) #星期日是 0 M = int(input("求多少天后？ ")) #输入正整数 D = __________________ if ______________: print(f"{M}后是星期日 ") else: print(f"{M}', options:["i <= 1", "i == 1", "i > 1", "i >= 1"], answer:2, explain:'本题正确答案为正选项。详细解析请参考CCF GESP官方真题答案解析文档。' },
            { type:'single', q:'下⾯ Python 代码执⾏后输出的是（ ）。', options:["55", "15", "9", "4"], answer:3, explain:'本题正确答案为A选项。详细解析请参考CCF GESP官方真题答案解析文档。' },
            { type:'single', q:'turtle.forward(100) 是（ ）。', options:["让海⻳向右转 100 度", "让海⻳向上移动 100 像素", "让海⻳向前移动 100 像素", "让海⻳向前移动 100 单位"], answer:2, explain:'本题正确答案为正选项。详细解析请参考CCF GESP官方真题答案解析文档。' },
            { type:'single', q:'为在 Python Turtle 中输出如下图形，代码横线处应填⼊（ ）。', options:["11", "1, 12Sum = 0 for i in range(10): if i % 2 == 0: continue if i % 5 == 0: break Sum += i print(Sum)1 2 3 4 5 6 7 8 import turtle turtle.pensize(2) for i in range(____________): if i % 2 == 0: turtle.col", "1, 13", "14"], answer:2, explain:'本题正确答案为正选项。详细解析请参考CCF GESP官方真题答案解析文档。' },
            { type:'single', q:'为在 Python Turtle 中输出如下图形，代码横线处应填⼊（ ）。', options:["30", "60", "90", "120 2"], answer:3, explain:'本题正确答案为正选项。详细解析请参考CCF GESP官方真题答案解析文档。' },
            // Q16-25
