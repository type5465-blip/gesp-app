...
{id: '2024-03',
        ...
        questions: [
            ...
            { type:'single', q:'Python表达式(3 - 2) * 3 + 5的值是 ( )。', options:["-13", "8", "10", "12"], answer:1, explain:'操作系统管理硬件和软件资源。鸿蒙(HarmonyOS)是华为开发的操作系统，其他选项为应用软件。' },
            ...
            { type:'single', q:'下⾯ Python 代码执⾏后的输出是（ ）。', options:["a+1= 2", "a+1=2", "2=2", "2= 2"], answer:1, explain:'本题正确答案为正选项。详细解析请参考CCF GESP官方真题答案解析文档。' },
            { type:'single', q:'下⾯ Python 代码执⾏时输⼊ 21 后，有关描述正确的是（ ）。', options:["仅有代码 4 ⾏被执⾏", "第4和第 7 ⾏代码都被执⾏", "仅有代码第 7 ⾏被执⾏", "第8⾏代码将被执⾏，因为input()输⼊为字符串"], answer:0, explain:'本题正确答案为正选项。详细解析请参考CCF GESP官方真题答案解析文档。' },
            { type:'single', q:'下⾯ Python 代码第 2 ⾏，总共被执⾏次数是（ ）。', options:["9", "10", "19", "20"], answer:3, explain:'本题正确答案为D选项。详细解析请参考CCF GESP官方真题答案解析文档。' },
            { type:'single', q:'下⾯ Python 代码执⾏后的输出是（ ）。', options:["7", "15", "18", "20"], answer:3, explain:'本题正确答案为正选项。详细解析请参考CCF GESP官方真题答案解析文档。' },
            { type:'single', q:'下⾯ Python 代码执⾏后的输出是（ ）。', options:["9#6#3#", "9#6#3#0#", "8#7#5#4#2#1#", "10#8#7#5#4#2#1#"], answer:1, explain:'本题正确答案为正选项。详细解析请参考CCF GESP官方真题答案解析文档。' },
            { type:'single', q:'下⾯ Python 代码⽤于判断键盘输⼊的整数是否为质数。质数是只能被 1 和它本⾝整除的数。在横线处应填⼊ 代码是（ ）。', options:["n % i", "n % i == 0", "n // i", "n / i"], answer:1, explain:'本题正确答案为正选项。详细解析请参考CCF GESP官方真题答案解析文档。' },
            { type:'single', q:'下⾯ Python 代码执⾏后的描述，正确的是（ ）。', options:["有4条蓝⾊线段 5 条红⾊线段，总计 9 条线段", "有4条红⾊线段 5 条蓝⾊线段，总计 9 条线段", "有5条蓝⾊线段 5 条红⾊线段，总计 10 条线段", "只有 1条线段，线段颜⾊为蓝⾊"], answer:3, explain:'本题正确答案为正选项。详细解析请参考CCF GESP官方真题答案解析文档。' },
            { type:'single', q:'下⾯ Python 执⾏后输出是（ ）。 题号 12345678910 答案', options:["红⾊正⽅形，四周封闭", "红⾊正⽅形，左边有缺⼝", "红⾊正⽅形，右边有缺⼝", "红⾊正⽅形，底边有缺⼝"], answer:1, explain:'本题正确答案为正选项。详细解析请参考CCF GESP官方真题答案解析文档。' },
            { type:'single', q:'下⾯ Python 代码执⾏后正确的图形是（ ）。', options:["完整圆形，但原位置重复三次，看起来是⼀个圆", "以坐标 (150,90) 为圆⼼的完整圆形", "不是完整圆形，缺少左下角的四分之⼀", "不是完整圆形，缺少右下角的四分之⼀"], answer:2, explain:'本题正确答案为正选项。详细解析请参考CCF GESP官方真题答案解析文档。' },
            { type:'single', q:'为画出如下所⽰图形，下⾯ Python 代码横线处应填⼊ ()。', options:["150", "100", "50", "0 2"], answer:1, explain:'本题正确答案为正选项。详细解析请参考CCF GESP官方真题答案解析文档。' },
            // Q16-25
