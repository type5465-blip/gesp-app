        ...
        ]},
{
        ...
        questions: [
            ...
            { type:'single', q:'Python表达式10 - 3 ** 2 % 10的值是 ( )。', options:["0", "1", "2", "3"], answer:1, explain:'无人驾驶选路需麦克风(听取指令)、扬声器(反馈)、传感器(感知)。油量表与路线选择无关。' },
            { type:'single', q:'假设现在是上午⼗点，求出N⼩时（正整数）后是第⼏天及时，如输⼊20⼩时则为第2天6点，如N输⼊4则为 今天14点。为实现相应功能，应在横线处填写代码是( )。', options:["(10 + N) % 24 , (10 + N) // 24", "(10 + N) // 24 , (10 + N) % 24", "N % 24 , N // 24", "10 // 24 , 10 % 24"], answer:1, explain:'本题正确答案为正选项。详细解析请参考CCF GESP官方真题答案解析文档。' },
            { type:'single', q:'下⾯的程序⽤于判断N是否为偶数，横线处应填写代码是（ ）。', options:["N % 2 == 0", "N % 2 = 0", "N % 2", "N % 2 != 0"], answer:0, explain:'本题正确答案为正选项。详细解析请参考CCF GESP官方真题答案解析文档。' },
            { type:'single', q:'下⾯对Python代码执⾏后输出的描述，正确的是（ ）。', options:["如果输⼊的N是⼩于等于2的整数，第5⾏将输出0。", "如果输⼊的N是⼤于等于2的整数，第5⾏将输出N-1。", "如果输⼊的N是⼤于等于2的整数，第5⾏将输出N。", "以上说法均不正确。"], answer:1, explain:'本题正确答案为正选项。详细解析请参考CCF GESP官方真题答案解析文档。' },
            { type:'single', q:'下⾯Python代码执⾏后的输出是（ ）。', options:["0", "5", "9", "10"], answer:2, explain:'本题正确答案为B选项。详细解析请参考CCF GESP官方真题答案解析文档。' },
            { type:'single', q:'下⾯ Python代码执⾏后的输出是（ ）。', options:["0", "1", "2", "3"], answer:0, explain:'本题正确答案为B选项。详细解析请参考CCF GESP官方真题答案解析文档。' },
            { type:'single', q:'下⾯ Python代码执⾏后的输出是（ ）。', options:["11", "10", "5", "4"], answer:2, explain:'本题正确答案为A选项。详细解析请参考CCF GESP官方真题答案解析文档。' },
            { type:'single', q:'下⾯ Python代码⽤于判断⼀个数是否为质数（素数），在横线处应填⼊代码是（ ）。', options:["cnt = 1", "cnt = 2", "cnt =+ 1", "cnt += 1"], answer:3, explain:'本题正确答案为正选项。详细解析请参考CCF GESP官方真题答案解析文档。' },
            { type:'single', q:'当执⾏turtle.forward()时，提⽰如下信息：NameError: name \'turtle\' is not defined. Did you mean: \'tuple\'?，下⾯描述正确的是（ ）。', options:["提⽰的含义有 “turtle没有定义 ”之意，故先执⾏turtle = 0即可", "将turtle修改为tuple后将不会报错", "turtle.forward()中的forward错误，必须先执⾏turtle.pendown()", "因为没有执⾏import turtle，故有此错误。"], answer:3, explain:'本题正确答案为正选项。详细解析请参考CCF GESP官方真题答案解析文档。' },
            { type:'single', q:'先后执⾏ Python代码import turtle和turtle.circle(10,steps = 3)后，正确的说法是（ ）。', options:["将绘制出半径为 10 ，弧度为 3 的圆", "将绘制出半径为 10 ，角度为 3 的圆", "将绘制出边长为 10 的正三边形，即等边三角形", "将绘制出半径为 10 的内接圆正三边形，即等边三角形"], answer:3, explain:'本题正确答案为正选项。详细解析请参考CCF GESP官方真题答案解析文档。' },
            { type:'single', q:'下⾯ Python代码执⾏后输出的正确图形是 ( )。', options:["正方形", "长方形", "正三角形", "圆形"], answer:0, explain:'本题正确答案为D选项。详细解析请参考CCF GESP官方真题答案解析文档。' },
