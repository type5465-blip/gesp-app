...
{id: '2025-12',
        ...
        questions: [
            ...
            { type:'single', q:'下面Python代码执行后输出是( )。', options:['10#20#30#40#50#60#70#80#90#','90#','90','没有输出'], answer:1, code:'for i in range(10, 100, 10):\n    if i % 10 == 0:\n        continue\n    print(i, end = “#”)\nprint(i)', explain:'range(10,100,10)生成10~90。每个数都满足i%10==0，全部被continue跳过。循环结束后i=90，print(i,end=”#”)输出”90#”。注意最后的print(i)不带end=”#”也会有输出。实际上代码结构是：循环内continue跳过所有print(i,end=”#”)，循环结束后单独print(i)输出90并带#结尾。最终输出”90#”。' },
...
{id: '2025-09',
        ...
        questions: [
            ...
            { type:'single', q:'下⾯的 Python 代码⽤于输⼊姓名，然后输出姓名，正确的说法是 ( )。', options:["XingMing 是汉语拼⾳，不能作为变量名称", "可以将 XingMing 改为 Xing Ming", "可以将 XingMing 改为 xingming", "可以将 XingMing 改为 Xing-Ming"], answer:2, explain:'本题正确答案为正选项。详细解析请参考CCF GESP官方真题答案解析文档。' },
            { type:'single', q:'下列 Python 代码执⾏后，其输出是 ( )。', options:["2.6 2 3", "2.623XingMing = input(\"请输入您的姓名： \") print(XingMing)1 2 a = 13 b = 5 print(a / b, a // b, a % b)1 2 3", "2 2 3", "2 3 4"], answer:0, explain:'本题正确答案为正选项。详细解析请参考CCF GESP官方真题答案解析文档。' },
            { type:'single', q:'Python表达式3 * 3 ** 3 // 3的值是( )。', options:["243", "81", "27", "9"], answer:2, explain:'本题正确答案为C选项。详细解析请参考CCF GESP官方真题答案解析文档。' },
            { type:'single', q:'下⾯的Python代码执⾏时如果先输⼊ 10 回车后输⼊ 20 并回车，其输出是( )。', options:["30", "1020", "{N+M}", "N+M"], answer:1, explain:'本题正确答案为正选项。详细解析请参考CCF GESP官方真题答案解析文档。' },
            { type:'single', q:'当前是9⽉，编写Python代码求N个⽉后的⽉份。横线处应填⼊的代码是（ ）。', options:["N % 12", "9 + N % 12", "(9 + N) // 12", "(9 + N) % 12"], answer:3, explain:'本题正确答案为正选项。详细解析请参考CCF GESP官方真题答案解析文档。' },
            { type:'single', q:'下⾯Python代码执⾏后的输出是（ ）。', options:["5050", "4950", "50", "49"], answer:2, explain:'本题正确答案为正选项。详细解析请参考CCF GESP官方真题答案解析文档。' },
            { type:'single', q:'下⾯的Python代码执⾏后输出是（ ）。N = input("第一个数:") M = input("第二个数:") print(f"{N+M}")1 2 3 N = int(input()) M = _____________ if M == 0: print(f"{N}个月后是12月") else: print(f"{N}个月后是{M}月")1 2 3 4 5 6 n = 0 for i in', options:["90", "100", "900", "1000"], answer:2, explain:'本题正确答案为正选项。详细解析请参考CCF GESP官方真题答案解析文档。' },
            { type:'single', q:'下⾯ Python 代码执⾏后输出是（ ）。', options:["1#2#", "1#2#END", "1#2", "1#2#3#4#END"], answer:0, explain:'本题正确答案为正选项。详细解析请参考CCF GESP官方真题答案解析文档。' },
            { type:'single', q:'下⾯的 Python 代码⽤于求 N 的镜⾯数（ N 的个位到最⾼位的各位数字依次反过来出现在数字中，但⾼位 0 将被 忽略，不输出），如输⼊ 1234，则将输出4321，⼜如输⼊ 120，则将输出21，错误的选项是（ ）。', options:["N != 0", "not (N == 0)", "N = 0", "N > 0"], answer:2, explain:'本题正确答案为正选项。详细解析请参考CCF GESP官方真题答案解析文档。' },
            { type:'single', q:'下⾯ Python 代码⽤于交换两个正整数，其不能实现的代码是（ ）。', options:["使用临时变量temp交换", "a, b = b, a", "使用加减法交换", "a=b; b=a"], answer:3, explain:'本题正确答案为C选项。详细解析请参考CCF GESP官方真题答案解析文档。' },
            { type:'single', q:'有关下⾯ Python 代码说法正确的是（ ）。', options:["代码执⾏后，海⻳会⽔平向右画⼀条 100 像素的直线", "因为在turtle.forward(100)之前没有执⾏turtle.pendown()，因此只会⽔平向右移动 100 像素，但不 会绘制直线", "因为在turtle.forward(100)之前没有执⾏turtle.pensize(n)，其中 n为正整数，因此只会⽔平向右移 动100像素，但不会绘制直线", "因为在turtle.forward(100)之前没有执⾏turtle.pencolor(color)，color 为合法的颜⾊值，因此 只会⽔平向右移动 100 像素，但不会绘制直线或者说绘制了直线，但与背景颜⾊保持⼀致，看不出是直线"], answer:0, explain:'本题正确答案为正选项。详细解析请参考CCF GESP官方真题答案解析文档。' },
            { type:'single', q:'为在 Python Turtle 中输出如下图形，代码横线处应填⼊（ ）。', options:["15", "30a = int(input(\"输入第一个正整数 : \")) b = int(input(\"输入第二个正整数 : \")) a = a + b b = a - b a = a - b print(\"a=\", a, \"b=\", b)1 2 3 4 5 6 a = int(input(\"输入第一个正整数 : \")) b = int(input(\"输入第二个正整数 : \")) a = b b = a p", "45", "90"], answer:1, explain:'本题正确答案为正选项。详细解析请参考CCF GESP官方真题答案解析文档。' },
            { type:'single', q:'为在 Python Turtle 中输出如下图形，代码横线处应填⼊（ ）。', options:["1", "2", "3", "4"], answer:3, explain:'本题正确答案为A选项。详细解析请参考CCF GESP官方真题答案解析文档。' },
            // Q16-25
