...
{id: '2024-06',
        ...
        questions: [
            // Q1-15
            { type:'single', q:'⼩杨⽗母带他到某培训机构给他报名参加 CCF 组织的 GESP 认证考试的第 1 级，那他可以选择的认证语⾔有⼏ 种？（ ）', options:["1种", "2种", "3种", "4种"], answer:2, explain:'错误。该说法与Python语言实际行为不符。建议在Python环境中实际运行测试验证。' },
            ...
            { type:'single', q:'在Python 中，假设 N 为正整数，则表达式print(N % 3 + N % 7)的最⼤值是 ( )。', options:["最⼤值为 6", "最⼤值为 8", "最⼤值为 9", "最⼤值为 10"], answer:1, explain:'本题正确答案为正选项。详细解析请参考CCF GESP官方真题答案解析文档。' },
            { type:'single', q:'Python语句print(f"5%2={5%2}",5 % 2)执⾏后的输出是 ( )。', options:["1={1} 1", "5%2={5%2}1", "5%2={5%2} 1", "5%2=1 1"], answer:3, explain:'本题正确答案为正选项。详细解析请参考CCF GESP官方真题答案解析文档。' },
            ...
            { type:'single', q:'下⾯ Python 代码执⾏后的输出是（ ）。', options:["102={102}", "a+1={a+1}", "a+1=102", "a先被赋值为浮点数，后被赋值为整数，执⾏将报错"], answer:2, explain:'本题正确答案为正选项。详细解析请参考CCF GESP官方真题答案解析文档。' },
            { type:'single', q:'下⾯ Python 代码执⾏后的输出是（ ）。', options:["5+5", "5+'5'", "10", "55"], answer:0, explain:'本题正确答案为正选项。详细解析请参考CCF GESP官方真题答案解析文档。' },
            ...
            { type:'single', q:'下⾯ Python 代码执⾏后，最终输出是（ ）。a = 101.101 a = 101 print(f"a+1={a+1}")1 2 3 a = "5" b = 5 print(f"{a}+{b}")1 2 3 N = int(input("请输入正整数： ")) if N % 3: print("第3行代码 ", N % 3, sep = "") else: print("第4行代码 ", N', options:["9 45", "10 55", "10 45", "11 55"], answer:0, explain:'本题正确答案为正选项。详细解析请参考CCF GESP官方真题答案解析文档。' },
            { type:'single', q:'下⾯ Python 代码⽤于判断 N 是否为质数（只能被 1 和它本⾝整除的正整数）。程序执⾏后，下⾯有关描述错 误的是（ ）。', options:["如果输⼊负整数，将输出 “ 不是质数 ”", "如果输⼊ 2 ，将输出 “ 是质数 ” ，因为 Flag 已被改变为 True", "如果输⼊ 2 ，将输出 “ 是质数 ” ，即便此时循环体没有被执⾏", "如果将if N >= 2:改为if N > 2:同样能正确判断 N 是否质数"], answer:3, explain:'本题正确答案为正选项。详细解析请参考CCF GESP官方真题答案解析文档。' },
            { type:'single', q:'下⾯的 Python 代码⽤于求 1-N 之间所有奇数之和，其中 N 为正整数，如果 N 为奇数求和时包括 N 。有关描述错 误的是（ ）。', options:["执⾏代码时如果输⼊ 10 ，则最后⼀⾏输出将是11 25Sum = 0 for i in range(10): Sum += i print(i,Sum)1 2 3 4 N = int(input(\"请输入整数： \")) Flag = False if N >= 2: Flag = True for i in range(2,N): if N % i == 0: Flag = False brea", "执⾏代码时如果输⼊ 5 ，则最后⼀⾏输出将是6 9", "将i += 1移到if i % 2 == 1:前⼀⾏且同样对齐，同样能实现题⽬要求", "删除if i % 2 == 1:，并将i += 1改为i += 2，且将Sum += i与i += 2同样对齐，同样可以实现 题⽬要求"], answer:2, explain:'本题正确答案为正选项。详细解析请参考CCF GESP官方真题答案解析文档。' },
            { type:'single', q:'下⾯ Python 代码执⾏后的描述，正确的是（ ）。', options:["共有 5条线段，蓝红相间，即蓝红蓝红蓝", "共有 3条线段，全部是蓝⾊，看起来是 1 条线段", "共有 6条线段，其中两条红⾊线段， 4 条蓝⾊线段", "以上说法都不正确"], answer:3, explain:'本题正确答案为正选项。详细解析请参考CCF GESP官方真题答案解析文档。' },
            ...
            { type:'single', q:'下⾯ Python 代码执⾏后输出的图形如下，横线处应填写的代码是（ ）。', options:["120import turtle for i in range(1,10,2): if i % 3 == 0: turtle.pencolor(\"red\") else: turtle.pencolor(\"blue\") turtle.forward(50)1 2 3 4 5 6 7 8 import turtle turtle.circle(100) turtle.circle(100, 360, ", "110", "100", "90"], answer:2, explain:'本题正确答案为正选项。详细解析请参考CCF GESP官方真题答案解析文档。' },
            { type:'single', q:'为画出如下所⽰图形，下⾯ Python 代码横线处应填⼊ ()。', options:["360", "180", "90", "45 2"], answer:2, explain:'本题正确答案为正选项。详细解析请参考CCF GESP官方真题答案解析文档。' },
            // Q16-25
